...
function main(project::String, plotflag::Bool, s::Dict{String,Any}, nSteps::Int,
    inputs::Array{Float64,2}, egomotion::Array{Float64,2}, test_inputs::Array{Float64,2}, test_egomotion::Array{Float64,2}, test_times::Array{Int,1};
    ...
    run_net(net, inputs, egomotion, test_inputs, test_egomotion, test_times, save_loc, s)
